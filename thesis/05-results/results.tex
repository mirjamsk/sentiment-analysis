...
All the data is accessible at \textit{sentiment-analysis.ml/stats/}. 
For this reason, the latter two bar charts contain only the precision and recall metrics for all variants of the Text-processing API which is the best performing API w.r.t accuracy.
